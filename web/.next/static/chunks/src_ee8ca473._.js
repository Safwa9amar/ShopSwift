...
function Home() {
    ...
    const categories = [
        'all',
        ...Array.from(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].map((p)=>p.category)))
    ];
    const filteredProducts = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].filter((product)=>product.name.toLowerCase().includes(searchTerm.toLowerCase())).filter((product)=>category === 'all' ? true : product.category === category);
...
_s(Home, "EIB5PFyi6A8jGjgKA8GXldp3Ej8=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_ee8ca473._.js.map